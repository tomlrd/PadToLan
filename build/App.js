...
function App() {
    ...
    var _a = useState(null), layout = _a[0], setLayout = _a[1];
    var _b = useState(null), selectedPage = _b[0], setSelectedPage = _b[1];
    var _c = useState(0), selectedPageI = _c[0], setSelectedPageI = _c[1];
    var _d = useState(0), pageW = _d[0], setPageW = _d[1];
    var _f = useState(selectedPageI), activeTab = _f[0], setActiveTab = _f[1];
    var _g = useState(false), noSleepDiv = _g[0], setNoSleepDiv = _g[1];
    useEffect(function () {
    ...
    return (_jsxs("div", { children: [noSleepDiv &&
                _jsx("div", { id: 'nosleep', children: _jsxs("div", { id: 'nosleepcontent', children: [_jsx("p", { children: "NoSleep activated and require a manual confirm" }), _jsxs("div", { id: 'nosleepconfirm', children: [_jsx("button", { onClick: function () { return handleNoSleep(true); }, children: "confirm" }), _jsx("button", { onClick: function () { return handleNoSleep(false); }, children: "cancel" })] })] }) }), layout && selectedPage &&
                _jsx("div", __assign({ id: "layoutdisplay", style: {
                    ...
                    } }, handlers, { children: _jsx("div", { id: 'layoutdisplaybgcolor', style: {
                            backgroundColor: selectedPage === null || selectedPage === void 0 ? void 0 : selectedPage.pageConfig.bgcolor,
                            height: "inherit"
                        }, children: _jsx(Tabs, { selectedIndex: selectedPageI, onSelect: function (index) { return handleChangePage(index); }, children: _jsxs("div", { style: {
                                    ...
                                    backgroundSize: selectedPage.pageListConfig.bgsize,
                                        ...
                                        }, children: layout.pages.map(function (page, index) { return (_createElement(Tab, __assign({}, handlers, { style: {
                                            ...
                                            _jsx("div", { className: 'tabinn', style: {
                                                    background: activeTab === index ? page.pageItemConfig.onclickbgcolor : page.pageItemConfig.bgcolor,
                                                }, children: page.name }))); }) }), layout.pages.map(function (page, index) { return (_jsx(TabPanel, { children: _jsx(GridLayout, { autoSize: true, compactType: null, width: pageW, cols: 12, rowHeight: 10, preventCollision: true, isBounded: false, children: page.items.map(function (item) { return (_jsx("button", { className: "btn", onClick: function (e) { return handleSendKey(e, item.action); }, "data-grid": {
                                                    x: item.grid.x,
                                                    y: item.grid.y,
                                                    w: item.grid.w,
                                                    h: item.grid.h,
                                                ...
                                                }, children: _jsx("div", { className: 'btninn', style: {
