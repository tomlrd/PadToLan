...
exports.DefaultLayouts = exports.getBlankItem = exports.getBlankPage = exports.getBlankLayout = exports.generateUID = void 0;
var layouts_1 = require("./types/layouts");
...
exports.getBlankLayout = getBlankLayout;
function getBlankPage() {
    return {
        ...
        pageConfig: {
            ...
            bgimg: 'none',
            bgsize: "cover",
            bgpos: { x: layouts_1.Pos.center, y: layouts_1.Pos.center },
            bgrepeat: layouts_1.BGRepeat.norepeat
        },
        pageListConfig: {
            bgcolor: "transparent",
            bgimg: "none",
            ...
            margin: "",
            padding: "",
            justifyitems: layouts_1.Justify.start
        },
        pageItemConfig: {
            color: "",
            bgcolor: "",
...
exports.getBlankPage = getBlankPage;
...
exports.getBlankItem = getBlankItem;
var SM = __assign(__assign({}, getBlankLayout()), { name: "Example Smartphone" });
...
SM.pages[0].items = [
    {
        ...
        bgsize: "cover",
        bgpos: {
            x: layouts_1.Pos.center,
            y: layouts_1.Pos.center
        },
        bgrepeat: layouts_1.BGRepeat.norepeat,
...
var TABLET = __assign(__assign({}, getBlankLayout()), { name: 'Example Tablet' });
exports.DefaultLayouts = [SM, TABLET];
